...
public class Controller {
     ...
     */
    public static void main(String[] args) throws ClientRequestException, JSONMapperException, ValidatorException {
    ...
    private static void sendGetRequest(String id, String ClientType) throws ClientRequestException, JSONMapperException {
    ...
    private static void sendPostRequest(String articleId, String ClientType) throws ClientRequestException, JSONMapperException {
        ...
        if (ClientType.equals("URL")) {
            ...
            stringResponse =  new MyHttpClient().doPost(articleId, requestParam);
        }
